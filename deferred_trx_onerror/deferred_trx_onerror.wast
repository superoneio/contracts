(module
 ...
 (table 3 3 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5eosio12onerror_test8overtimeEy $_ZN5eosio12onerror_test8sendderrEy)
 (memory $0 1)
  ...
  (block $label$6
   ...
   (block $label$23
    (br_if $label$23
     (i64.eq
      (get_local $2)
      (i64.const -4420682522208239616)
     )
    )
    (br_if $label$6
     (i64.ne
      (get_local $2)
      (i64.const -6425092153826869248)
     )
    )
    (i32.store offset=28
     (get_local $9)
    ...
    (drop
     (call $_ZN5eosio14execute_actionINS_12onerror_testES1_JyEEEbPT_MT0_FvDpT1_E
      (i32.add
       (get_local $9)
       (i32.const 96)
      )
 ...
 (func $_ZN5eosio12onerror_test8overtimeEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (call $eosio_assert
   (i32.const 0)
   (i32.const 48)
  )
 )
 (func $_ZN5eosio14execute_actionINS_12onerror_testES1_JyEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN5eosio12onerror_test8sendderrEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
